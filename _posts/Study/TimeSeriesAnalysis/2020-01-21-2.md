...
- Moving average를 통해 trend $\hat{m}_t$를 찾을 수 있다. <br>
...
[^1]: [1. Review of Related Statistics - Autocovariance function](https://djy-git.github.io/2020/01/21/1.html#--autocovariance-function)
