...
7. &nbsp;  &emsp; $AP = P\Lambda$
8. &nbsp; &emsp; The *proper* $P$ is a matrix whose column vectors are eigenvector and $\Lambda$ is a *eigenmatrix*. <br>
&nbsp; &emsp; (*eigenmatrix*: diagonal matrix whose diagonals are eigenvalues)
9. &nbsp; &emsp; **If** all eigenvalues of $A$ are different **then**,
10. &nbsp; &emsp; &emsp; Regular matrix $P$ exists (eigenvectors are linearly independent)
11. &nbsp; &emsp; **else,**
12. &nbsp; &emsp; &emsp; $\Lambda$ can be *Jordan standard form*
