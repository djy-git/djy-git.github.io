...
\textbf{Similarity transformation: } A \to \Lambda = P^{-1}AP $
...
<br>
#### Geometric meaning
Eigenvector: $A$를 곱해도 신축만 되고, 방향은 변하지 않는 vector <br>
...
11. $ \text{For regular matrix S, } S^{-1}AS: (\lambda, S^{-1}\mathbf{p}) $
