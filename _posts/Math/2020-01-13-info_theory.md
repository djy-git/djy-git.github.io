...
- 어떤 확률변수의 분포가 deterministic 하다면, 해당 확률분포의 불확실성 정도를 나타내는 entropy는 작은 값을 가진다.($\Sigma log 1 = 0$) <br> 반대로, 확률분포가 uniform 분포라면 높은 entropy를 가진다.([0, 1]의 값을 가질 수 있는 확률변수의 경우, $$)
