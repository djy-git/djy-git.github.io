...
### 선물(先物, futures)
[파생상품]()의 한 종류로서 품질, 수량, 규격 등이 표준화되어 있는 상품 또는 금융자산을 미리 결정된 가격으로 미래 일정시점에 인도·인수할 것을 약정한 거래를 말한다. 시세변동에 따른 위험을 회피하기 위해 개발되었다.
...
- (위탁)증거금  
선물 계약은 기본적으로 후불이나 계약 시점에 보증금 성격의 증거금을 부과하기도 한다. KOSPI200 지수선물의 위탁증거금은 7.5%로 증거금율은 거래소가 정하며 시장 상황에 따라 수시로 변경된다.  
