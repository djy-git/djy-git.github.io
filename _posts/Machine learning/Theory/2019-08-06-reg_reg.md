...
**Ridge regression (Tikhonov regularization)**: cost funtion에 l2 regularization ($\alpha \Sigma_i \theta_i^2$)이 추가된 선형 회귀 <br> **Lasso regression**: cost funtion에 l1 regularization ($ \alpha \Sigma_i | \theta_i | $)이 추가된 선형 회귀 <br> **Elastic net**: cost funtion에 l1, l2 regularization을 모두 추가한 선형 회귀
{:.success}
