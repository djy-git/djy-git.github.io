...
### 3. E-step (Expectation): Update the lower bound $B[\left\{q_i(h_i)\right\{, \theta]$ w.r.t. $q_i(h_i)$
Fix $\theta$ in E-step <br>

#### 1) Express on $ B[\left\{q_i(h_i)\right\{, \theta] $
...
#### 2) Optimize $q_i(h_i)$ on $ B[\left\{q_i(h_i)\right\{, \theta] $
...
### 4. M-step (Maximization): Maximize the lower bound $B[\left\{q_i(h_i)\right\}, \theta]$ w.r.t. parameters $\theta$
